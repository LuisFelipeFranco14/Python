...
class ClientForm(forms.ModelForm):
    name = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Informe seu nome'}),label="Nome")
    email = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Informe seu E-mail'}),label="E-mail")
    phone = forms.CharField(max_length=10,widget=forms.TextInput(attrs={'placeholder': 'Informe seu Telefone', 'OnKeyPress':'formatar("#####-####", this)'}),label="Telefone")
    class Meta:
        model = Client
        fields = '__all__'
