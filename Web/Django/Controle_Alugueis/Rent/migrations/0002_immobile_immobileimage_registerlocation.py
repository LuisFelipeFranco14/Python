    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('immobile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='immobile_images', to='Rent.immobile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('immobile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reg_location', to='Rent.immobile')),
            ],
            options={
