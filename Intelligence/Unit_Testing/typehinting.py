...
booleano: bool = False
string: str = 'Luis Felipe'

# Sequências
lista: List[int] = [1, 2, 3]
lista_str_int: List[Union[int, str]] = [1, 2, 3, 'Luis']
tupla: Tuple[int, int, int, str] = (1, 2, 3, 'Luis')
...
pessoa: Dict[str, Union[str, int]] = {
    'nome': 'Luis Felipe', 'sobrenome': 'Franco', 'idade': 30}
pessoa2: MeuDict = {'nome': 'Luis Felipe',
                    'sobrenome': 'Franco', 'idade': 30, 'l': [1, 2]}

# Meu outro tipo
UserId = NewType('UserId', int)
user_id = UserId(511515515)
